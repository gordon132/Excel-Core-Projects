...
## Projects
### 1. Sales Dashboard
A dashboard that analyzes sales data, tracks monthly performance using pivot tables and charts.
### 2. Employee Payroll System
A payroll system that calcluates employee salaries, overtime pay, and net pay using Excel formulas.
### 3. Student Gradebook System
